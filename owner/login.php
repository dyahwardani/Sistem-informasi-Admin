...
<head>
    ...
    <title>Nayfa Travel | Login</title>
...
<body class="gray-bg">
       ...
       <div class="loginColumns animated fadeInDown">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="font-bold">Owner Login</h2>
                <img src="../Nayfa/Versi02_293x290.png" style="padding: 10px 10px;">
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <a href='../index.php'>Copyright Nayfa Travel </a>
            </div>
