  <?php
            ...
            $id_admin = strip_tags($_GET['id_admin']);
            ...
            if(isset($_POST['btnsave']))
            {
                ...
                if(!isset($errMSG))
                {
                    $stmt = "UPDATE admin SET username='$username',password='$password' where id_admin='$id'";
...
<div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form action="?page=form_update_password" method="post" class="form-horizontal">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Password</label>
                                    ...
                                    <input type="hidden" class="form-control" name="id" value="<?php echo $id_admin;?>"></div>
                                </div> 
