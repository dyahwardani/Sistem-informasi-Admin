 ...
 <!-- <div class="container">
    <p>
    Export Data to Word:
    <a href="?page=detail_print&&id=<?php echo $idber; ?>&&tanggal=<?php echo $tanggal; ?>" target="_blank" type="button" class="btn btn-default"><span class="glyphicon glyphicon-export"></span>Export</a>
    </p>
 </div> -->
 <!-- <div class="title-action">
    <a href="?page=detail_print&&id=<?php echo $idber; ?>&&tanggal=<?php echo $tanggal; ?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print  </a>
</div> -->
 ...
 <div class="wrapper wrapper-content animated fadeInRight">
         ...
         <div class="ibox-content p-xl" id="div1">
             <div class="row">
                 ...
                 <div class="col-sm-6 text-right">
                     <H4 class="text-navy"> Operator : <?php echo $namauser ?> </H4>
                     <h4 class="text-navy">ID Keberangkatan : <?php echo $idber; ?></h4>
                     <h4 class="text-navy">Tanggal Berangkat : <?php echo $tanggal; ?></h4>
                     ...
                     <tbody>
                         <?php
                            ...
                            ?>
                             <tr>
                                 <td>
                                     <div><strong><?php echo $col2['rute']; ?></strong></div>
                                 </td>
                     ...
                     <tbody>
                         <?php
                            ...
                            ?>
                             <tr>
                                 <td>
                                     <div><strong><?php echo $col6['alamat_jemput']; ?></strong></div>
                                 </td>
                     ...
                     <tbody>
                         <?php
                            ...
                            ?>
                             <tr>
                                 <td>
                                     <div><strong><?php echo $col22['rute']; ?></strong></div>
                                 </td>
                     ...
                     <tbody>
                         <?php
                            ...
                            ?>
                             <tr>
                                 <td>
                                     <div><strong><?php echo $col66['alamat_jemput']; ?></strong></div>
                                 </td>
             ...
             <table>
                 ...
                 <tr>
                     <td>UANG SAKU</td>
                     <td> : Rp <?php echo $col4['saku']; ?></td>
                 </tr>
                 <tr>
                     <td>BBM</td>
                     <td> : Rp <?php echo $col4['bbm']; ?></td>
                 </tr>
                 <tr>
                     <td>TOL</td>
                     <td> : Rp <?php echo $col4['tol']; ?></td>
                 </tr>
                 <tr>
                     <td>PARKIR</td>
                     <td> : Rp <?php echo $col4['parkir']; ?></td>
                 </tr>
                 <tr>
                     <td>FEE DRIVER</td>
                     <td> : Rp <?php $col4['']; ?></td>
         ...
         <div class="ibox-content p-xl">
             <div class="text-center">
                 <!-- <a href="?page=detail_print&&id=<?php echo $idber; ?>&&tanggal=<?php echo $tanggal; ?>" target="_blank" class="btn btn-primary" id="prin"><i class="fa fa-print"></i> Print Surat </a> -->
                 <button class="btn btn-primary" onclick="printContent('div1')"><i class="fa fa-print"></i> Cetak</button>
                 <!-- <a href="javascript:printDiv('print-area')" class="btn btn-primary" id="prin"><i class="fa fa-print"></i> Print Surat </a> -->
             </div>
         </div>
    
 </div>
 <!-- <textarea id="print-css" style="display: none;">.no-print{display:none}</textarea>
 <iframe id="print-frame" name="print-frame" src="about:blank" style="display: none;"></iframe> -->
 <script>
    ...
    //  }
     ...
     //      var a = document.getElementById('print-css').value;
     //      var b = document.getElementById(elementId).innerHTML;
     //      var c = 'table{' + dumpCSSText(document.querySelector('table')) + '}';

     //      window.frames["print-frame"].document.title = document.title;
     //      window.frames["print-frame"].document.body.innerHTML = '<style>' + a + c + '</style>' + b;
    ...
    //      window.frames["print-frame"].document.title = document.title;
    //      window.frames["print-frame"].document.body.innerHTML = '<style>' + a + '</style>' + b;
    //      window.frames["print-frame"].window.focus();
    //      window.frames["print-frame"].window.print();
